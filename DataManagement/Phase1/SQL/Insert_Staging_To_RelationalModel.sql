 ...
 * The script assumes a staging database (imdb_staging, created using SQL Server Impor tool) equivalent to the data files that contains the data in text format.
